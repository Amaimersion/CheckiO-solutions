...
if __name__ == "__main__":
    ...
    army_7 = Army()
    army_7.add_units(Warrior, 2)
    army_7.add_units(Knight, 1)

    army_8 = Army()
    army_8.add_units(Knight, 1)
    army_8.add_units(Healer, 1) # what the hell are you doing here?
    army_8.add_units(Knight, 1)
    ...
    assert battle.straight_fight(army_7, army_8) == True
